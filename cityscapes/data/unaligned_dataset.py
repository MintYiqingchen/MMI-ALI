...
class UnalignedDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        if opt.ndomains == 3:
            ...
            if not opt.supervised:
                self.transform_C = get_transform(self.opt, grayscale=(self.output_nc == 1))
    ...
    def __getitem__(self, index):
        ...
        if self.opt.serial_batches:
            ...
            A_transform = self.transform_A
            B_transform = self.transform_B
            if self.opt.ndomains == 3:
                C_transform = self.transform_C
